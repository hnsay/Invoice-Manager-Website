...
<?php                 //regex escape the value and store in array?>
    ...
    if (cellTexts.length == 0) {
      ...
      //var thirdSelector = document.getElementById('selector3').value; 
      // no need since already defined above

      var warningText = "Seçtiğiniz " +
      cellTexts.length + " Faturada Aşağıdaki İşlemler Yapılacak, EMİN MİSİNİZ?\n\n";
